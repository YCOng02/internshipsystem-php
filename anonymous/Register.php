            ...
            <form method="POST" action="registerUser.php">
                ...
                <div class="row mt-4 justify-content-center">
                    ...
                    <div class="row" style="width: 60%; margin-right: 15px;">
                        ...
                        <div class="w-75">
                            <input type="radio" id="rblQualification1" name="qualification" value="Diploma" required>
                ...
                <div class="row mt-4 justify-content-center">
                    ...
                    <div class="row" style="width: 60%; margin-right: 15px;">
                        ...
                        <div class="w-75">
                            <select id="ddlInternshipSession" name="internship_session" class="form-select" required>
